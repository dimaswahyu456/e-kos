...
@slot('title') Add Payment @endslot
@endcomponent
      ...
      <div class="card-body">
        <form action="{{ route('payment.add') }}" method="POST">
          ...
          <div class="mb-3 row">
            ...
            <div class="col-md-10">
              <input class="form-control" type="text" name="kode_payment" id="kode_payment" value="{{ $kode_payment }}" placeholder="Kode Payment" readonly>
            </div>
            <br><br>
