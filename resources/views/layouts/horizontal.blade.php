        ...
        <div class="d-flex">
            ...
            <div class="navbar-brand-box">
                <a href="{{url('index')}}" class="logo logo-dark">
                    <span class="logo-sm">
                        <img src="{{ URL::asset('/assets/images/kotaklogo.png'') }}" alt="" height="22">
                    </span>
                    <span class="logo-lg">
                        <img src="{{ URL::asset('/assets/images/logodark.png'') }}" alt="" height="20">
                    </span>
                </a>
                ...
                <a href="{{url('index')}}" class="logo logo-light">
                    ...
                    <span class="logo-lg">
                        <img src="{{ URL::asset('/assets/images/logolight.png') }}" alt="" height="20">
                    </span>
                </a>
            </div>
