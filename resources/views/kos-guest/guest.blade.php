...
<head>
    ...
    <!-- Vendor CSS Files -->
    <link href="{{ URL::asset('/assets/guest/vendor/bootstrap/css/bootstrap.min.css')}}" rel="stylesheet">
    <link href="{{ URL::asset('/assets/guest/vendor/bootstrap-icons/bootstrap-icons.css')}}" rel="stylesheet">
  <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/animate.css/4.1.1/animate.min.css">
    <link href="{{ URL::asset('/assets/guest/vendor/glightbox/css/glightbox.min.css')}}" rel="stylesheet">
    <link href="{{ URL::asset('/assets/guest/vendor/swiper/swiper-bundle.min.css')}}" rel="stylesheet">

    <!-- Main CSS File -->
    <link href="{{ URL::asset('/assets/guest/css/main.css')}}" rel="stylesheet">
...
<body class="index-page">
    ...
    <div class="container-fluid container-xl position-relative d-flex align-items-center ">
      ...
      <a href="index.html " class="logo d-flex align-items-center me-auto ">
        ...
        <h1 class="sitename ">E-Kos</h1>
      </a>

      <nav id="navmenu " class="navmenu " style="background-color: transparent !important; ">
        <ul>
      ...
      <div class="container">
        <div class="row gy-4 ">
          <div class="col-lg-6 order-2 order-lg-1 d-flex flex-column justify-content-center" data-aos="zoom-out ">
            <h1 >Tinggal Nyaman dengan Fasilitas Lengkap di Lokasi Strategis</h1>
            <br>
            <div class="d-flex ">
              <a href="#about " class="btn-get-started ">Jelajahi Kost</a>
            </div>
          </div>
...
<section id="keunggulan" class="services section light-background">
  ...
  <div class="container">
    <div class="row gy-4">
      <!-- Dapur Umum -->
      <div class="col-12 col-md-6 col-lg-3 d-flex justify-content-center" data-aos="fade-up" data-aos-delay="100">
        <div class="service-item position-relative text-center">
          <h4>
            <a href="#" class="stretched-link" data-bs-toggle="modal" data-bs-target="#modalDapur">
              Dapur Umum
            </a>
          </h4>
          <p>Memiliki dapur umum yang terletak di belakang kost dan freezer</p>
        </div>
      </div>
      ...
      <div class="col-12 col-md-6 col-lg-3 d-flex justify-content-center" data-aos="fade-up" data-aos-delay="100">
        <div class="service-item position-relative text-center">
          <h4>
            <a href="#" class="stretched-link" data-bs-toggle="modal" data-bs-target="#modalParkir">
              Tempat Parkir
            </a>
          </h4>
          <p>Memiliki 2 area tempat parkir kost yang luas dan nyaman, dilengkapi dengan sistem keamanan 24 jam untuk memberikan kenyamanan dan perlindungan bagi penghuni kost.</p>
        </div>
      </div>

      <!-- Free Wifi -->
      <div class="col-12 col-md-6 col-lg-3 d-flex justify-content-center" data-aos="fade-up" data-aos-delay="300">
        <div class="service-item position-relative text-center">
          <h4>
            <a href="#" class="stretched-link" data-bs-toggle="modal" data-bs-target="#modalWifi">
              Free Wifi
            </a>
          </h4>
          <p>Memiliki free wifi yang menjangkau seluruh kost</p>
        </div>
      </div>
      ...
      <div class="col-12 col-md-6 col-lg-3 d-flex justify-content-center" data-aos="fade-up" data-aos-delay="300">
        <div class="service-item position-relative text-center">
          <h4>
            <a href="#" class="stretched-link" data-bs-toggle="modal" data-bs-target="#modalJemur">
              Tempat Penjemuran
            </a>
          </h4>
          <p>Memiliki tempat penjemuran di lantai atas yang praktis dan nyaman, dilengkapi dengan area yang cukup untuk menjemur pakaian sehari-hari dengan aman dan terorganisir.</p>
        </div>
      </div>
    </div>
  </div>
    ...
    <!-- Modal Dapur -->
    <div class="modal fade" id="modalDapur" tabindex="-1" aria-labelledby="modalDapurLabel" aria-hidden="true">
      <div class="modal-dialog">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="modalDapurLabel">Dapur Umum</h5>
    ...
    <!-- Modal Parkir dengan Carousel -->
    <div class="modal fade" id="modalParkir" tabindex="-1" aria-labelledby="modalParkirLabel" aria-hidden="true">
      <div class="modal-dialog">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="modalParkirLabel">Tempat Parkir</h5>
            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
          </div>
          <div class="modal-body">
            <div id="carouselParkir" class="carousel slide" data-bs-ride="carousel">
              <div class="carousel-inner">
                <div class="carousel-item active">
                  <img src="{{ URL::asset('/assets/guest/img/parkir1.jpg')}}" class="d-block w-100" alt="Area Parkir 1">
                </div>
                <div class="carousel-item">
                  <img src="{{ URL::asset('/assets/guest/img/parkir2.jpg')}}" class="d-block w-100" alt="Area Parkir 2">
                </div>
              </div>
    ...
    <div class="modal fade" id="modalWifi" tabindex="-1" aria-labelledby="modalWifiLabel" aria-hidden="true">
      <div class="modal-dialog">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="modalWifiLabel">Free Wifi</h5>
            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
          </div>
          <div class="modal-body">
            <img src="{{ URL::asset('/assets/guest/img/wifi.jpg')}}" class="img-fluid" alt="Free Wifi">
          </div>
        </div>
      </div>
    </div>
    ...
    <!-- Modal Jemur -->
    <div class="modal fade" id="modalJemur" tabindex="-1" aria-labelledby="modalJemurLabel" aria-hidden="true">
      <div class="modal-dialog">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="modalJemurLabel">Tempat Penjemuran</h5>
            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
          </div>
          <div class="modal-body">
    ...
    <!-- Portfolio Section -->
    <section id="kamar" class="portfolio section ">
      ...
      <div class="container mt-3">
        <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 g-3">
          ...
          <div class="col">
            <div class="card">
              <img src="{{ URL::asset('/assets/guest/img/kamar.jpg')}}" class="card-img-top" alt="Kamar Kost 1">
              <div class="card-body">
                <h5 class="card-title">Foto Kamar 1</h5>
                <p class="card-text">Kamar kost putra dengan fasilitas lengkap, nyaman, dan lokasi strategis. Cocok untuk mahasiswa atau pekerja.</p>
                <a class="btn btn-primary" href="kamar/kamar1.html">Lihat Detail</a>
              </div>
            </div>
          </div>
          <!-- Card 2 -->
          <div class="col">
            <div class="card">
              <img src="{{ URL::asset('/assets/guest/img/kamar2.jpg')}}" class="card-img-top" alt="Kamar Kost 2">
              <div class="card-body">
                <h5 class="card-title">Foto kamar 2</h5>
                <p class="card-text">Kamar kost putra dengan fasilitas lengkap, nyaman, dan lokasi strategis. Cocok untuk mahasiswa atau pekerja.</p>
                <a href="kamar/kamar2.html" class="btn btn-primary">Lihat Detail</a>
              </div>
            </div>
          </div>
          <!-- Card 3 -->
          <div class="col">
            <div class="card">
              <img src="{{ URL::asset('/assets/guest/img/kamar.jpg')}}" class="card-img-top" alt="Kamar Kost 3">
              <div class="card-body">
                <h5 class="card-title">Foto kamar 3</h5>
                <p class="card-text">Kamar kost putra dengan fasilitas lengkap, nyaman, dan lokasi strategis. Cocok untuk mahasiswa atau pekerja.</p>
                <a href="kamar/kamar3.html" class="btn btn-primary">Lihat Detail</a>
              </div>
            </div>
          </div>
        </div>
  ...
  -->
            ...
            <div class="container copyright text-center mt-4 ">
                <p>© <span>Copyright</span> <strong class="px-1 sitename ">SobatWeb</strong> <span>2024 All Rights Reserved</span></p>
            </div>
        </footer>
        ...
        <!-- Vendor JS Files -->
        <script src="{{ URL::asset('/assets/guest/vendor/bootstrap/js/bootstrap.bundle.min.js')}}"></script>
        <script src="{{ URL::asset('/assets/guest/vendor/php-email-form/validate.js')}}"></script>
        <script src="{{ URL::asset('/assets/guest/vendor/aos/aos.js')}}"></script>
        <script src="{{ URL::asset('/assets/guest/vendor/glightbox/js/glightbox.min.js')}}"></script>
        <script src="{{ URL::asset('/assets/guest/vendor/swiper/swiper-bundle.min.js')}}"></script>
        <script src="{{ URL::asset('/assets/guest/vendor/waypoints/noframework.waypoints.js')}}"></script>
        <script src="{{ URL::asset('/assets/guest/vendor/imagesloaded/imagesloaded.pkgd.min.js')}}"></script>
        <script src="{{ URL::asset('/assets/guest/vendor/isotope-layout/isotope.pkgd.min.js')}}"></script>

        <!-- Main JS File -->
        <script src="{{ URL::asset('/assets/guest/js/main.js')}}"></script>
